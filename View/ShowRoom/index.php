...
<?php
    ...
    <ul style="margin-left: 40%; width:30%; ">
        ...
        while($i<=ceil($tongsobanghi/$s_bghimoitrang))
        {?>
            <li style="float: left; list-style-type: none;"><a style="display: block; padding: 10px; border: solid 2px red; background-color: black; " href="<?php $str=WEBROOT."index.php/showroom/index/";
            $str.=$i;
                echo $str; ?>" ><?php echo $i;?></a></li>
        <?php
            $i++;
